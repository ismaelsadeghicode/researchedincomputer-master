...
<div id="collapseOne" class="accordion-body collapse in body">
    <form:form action="${pageContext.request.contextPath}/admin/conferancInventory/addConferanc"
         ...
         <div class="form-group">
            ...
            <div class="col-lg-4">
                    <form:input path="conferancName" type="text" id="name" name="required2" class="form-control"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="Brand" type="text" id="bran" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="title" type="text" id="titl" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="status" type="text" id="statu" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="description" type="text" id="descrip" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="sentData" type="date" id="sent" name="date1" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="acceptData" type="date" id="date2" name="required2" class="form-control" />
            </div>
        </div>
        <div class="form-group">
            <label for="date3" class="control-label col-lg-4"> تاریخ پرداخت هزینه </label>
            <div class="col-lg-4">
                <form:input  path="costData" type="date" id="date3" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="base" type="text" id="bas" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="address" type="text" id="addre" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="patchData" type="date" id="date4" name="required2" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <form:input  path="phoneNumber" type="text" id="phone" name="required2" class="form-control" />
            </div>
        </div>
